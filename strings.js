...
export const intro =
  "Everyone can Google an artist to check for nearby perfomances, but in reality how many of us have time to do that? There should be a better (and lazier) solution. One that would require <b>zero</b> effort.";
